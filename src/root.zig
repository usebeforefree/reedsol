...
pub fn encode(
    ...
    /// Shards have to be defined. Size must be a power of two.
    data: []const []const u8,
    ...
    /// Shards can be undefined. Size must be a power of two.
    parity: []const []u8,
    parity_count: usize,
    ...
    if (parity.len < parity_count_next_pow2) return error.ParityBufferSizeTooSmall;
